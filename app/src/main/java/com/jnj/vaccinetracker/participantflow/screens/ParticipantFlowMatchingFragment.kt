...
class ParticipantFlowMatchingFragment : BaseFragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View {
        ...
        binding.btnMatchParticipant.setOnClickListener {
            viewModel.getSelectedParticipantSummary()?.let { startParticipantVisitContradictions(it, false) }
        }
        ...
        when (requestCode) {
            Constants.REQ_REGISTER_PARTICIPANT -> {
                ...
                if (participant == null) {
                    ...
                    startParticipantVisitContradictions(participant, true)
                }
    ...
    private fun startParticipantVisitContradictions(participant: ParticipantSummaryUiModel, newRegisteredParticipant: Boolean) {
        startActivity(ContradictionsActivity.create(requireContext(), participant, newRegisteredParticipant))
        (requireActivity() as BaseActivity).setForwardAnimation()
    }
