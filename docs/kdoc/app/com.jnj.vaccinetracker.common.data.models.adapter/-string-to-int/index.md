[app](../../index.md) / [com.jnj.vaccinetracker.common.data.models.adapter](../index.md) / [StringToInt](./index.md)

# StringToInt

`@JsonQualifier annotation class StringToInt`

### Constructors

| Name | Summary |
|---|---|
| [&lt;init&gt;](-init-.md) | `StringToInt()` |
