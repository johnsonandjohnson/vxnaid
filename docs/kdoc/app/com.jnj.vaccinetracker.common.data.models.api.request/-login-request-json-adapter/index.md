[app](../../index.md) / [com.jnj.vaccinetracker.common.data.models.api.request](../index.md) / [LoginRequestJsonAdapter](./index.md)

# LoginRequestJsonAdapter

`class LoginRequestJsonAdapter : JsonAdapter<`[`LoginRequest`](../-login-request/index.md)`>`

### Constructors

| Name | Summary |
|---|---|
| [&lt;init&gt;](-init-.md) | `LoginRequestJsonAdapter(moshi: Moshi)` |

### Functions

| Name | Summary |
|---|---|
| [fromJson](from-json.md) | `fun fromJson(reader: JsonReader): `[`LoginRequest`](../-login-request/index.md) |
| [toJson](to-json.md) | `fun toJson(writer: JsonWriter, value: `[`LoginRequest`](../-login-request/index.md)`?): `[`Unit`](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-unit/index.html) |
