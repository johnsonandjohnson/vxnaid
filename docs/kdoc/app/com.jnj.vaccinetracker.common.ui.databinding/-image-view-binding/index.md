[app](../../index.md) / [com.jnj.vaccinetracker.common.ui.databinding](../index.md) / [ImageViewBinding](./index.md)
...
| Name | Summary |
|---|---|
| [bindAsyncImage](bind-async-image.md) | `fun bindAsyncImage(imageView: ImageView, url: `[`String`](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)`?, placeHolderResource: `[`Int`](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-int/index.html)`): `[`Unit`](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-unit/index.html) |
