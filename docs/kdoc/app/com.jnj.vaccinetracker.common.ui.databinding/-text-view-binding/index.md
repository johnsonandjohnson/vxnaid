[app](../../index.md) / [com.jnj.vaccinetracker.common.ui.databinding](../index.md) / [TextViewBinding](./index.md)
...
| Name | Summary |
|---|---|
| [bindEndDrawable](bind-end-drawable.md) | `fun bindEndDrawable(textView: TextView, imageResource: `[`Int`](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-int/index.html)`): `[`Unit`](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-unit/index.html) |
| [bindStartDrawable](bind-start-drawable.md) | `fun bindStartDrawable(textView: TextView, imageResource: `[`Int`](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-int/index.html)`): `[`Unit`](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-unit/index.html) |
| [bindTopDrawable](bind-top-drawable.md) | `fun bindTopDrawable(textView: TextView, imageResource: `[`Int`](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-int/index.html)`): `[`Unit`](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-unit/index.html) |
