[app](../../index.md) / [com.jnj.vaccinetracker.splash](../index.md) / [SplashViewModel](./index.md)
...
| Name | Summary |
|---|---|
| [StartTarget](-start-target/index.md) | `enum class StartTarget` |

### Constructors

| Name | Summary |
|---|---|
| [&lt;init&gt;](-init-.md) | `SplashViewModel(userRepository: `[`UserRepository`](../../com.jnj.vaccinetracker.common.data.repositories/-user-repository/index.md)`)` |

### Functions

| Name | Summary |
|---|---|
| [getStartTarget](get-start-target.md) | `fun getStartTarget(): `[`SplashViewModel.StartTarget`](-start-target/index.md) |
