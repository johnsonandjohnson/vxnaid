[app](../../index.md) / [com.jnj.vaccinetracker.common.data.models.api.response](../index.md) / [ConfigurationJsonAdapter](./index.md)

# ConfigurationJsonAdapter

`class ConfigurationJsonAdapter : JsonAdapter<`[`Configuration`](../-configuration/index.md)`>`

### Constructors

| Name | Summary |
|---|---|
| [&lt;init&gt;](-init-.md) | `ConfigurationJsonAdapter(moshi: Moshi)` |

### Functions

| Name | Summary |
|---|---|
| [fromJson](from-json.md) | `fun fromJson(reader: JsonReader): `[`Configuration`](../-configuration/index.md) |
| [toJson](to-json.md) | `fun toJson(writer: JsonWriter, value: `[`Configuration`](../-configuration/index.md)`?): `[`Unit`](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-unit/index.html) |
