[app](../../index.md) / [com.jnj.vaccinetracker.common.data.models.api.response](../index.md) / [LoginResponseJsonAdapter](./index.md)

# LoginResponseJsonAdapter

`class LoginResponseJsonAdapter : JsonAdapter<`[`LoginResponse`](../-login-response/index.md)`>`

### Constructors

| Name | Summary |
|---|---|
| [&lt;init&gt;](-init-.md) | `LoginResponseJsonAdapter(moshi: Moshi)` |

### Functions

| Name | Summary |
|---|---|
| [fromJson](from-json.md) | `fun fromJson(reader: JsonReader): `[`LoginResponse`](../-login-response/index.md) |
| [toJson](to-json.md) | `fun toJson(writer: JsonWriter, value: `[`LoginResponse`](../-login-response/index.md)`?): `[`Unit`](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-unit/index.html) |
