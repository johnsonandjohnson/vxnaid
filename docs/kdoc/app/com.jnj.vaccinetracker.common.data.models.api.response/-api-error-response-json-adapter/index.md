[app](../../index.md) / [com.jnj.vaccinetracker.common.data.models.api.response](../index.md) / [ApiErrorResponseJsonAdapter](./index.md)

# ApiErrorResponseJsonAdapter

`class ApiErrorResponseJsonAdapter : JsonAdapter<`[`ApiErrorResponse`](../-api-error-response/index.md)`>`

### Constructors

| Name | Summary |
|---|---|
| [&lt;init&gt;](-init-.md) | `ApiErrorResponseJsonAdapter(moshi: Moshi)` |

### Functions

| Name | Summary |
|---|---|
| [fromJson](from-json.md) | `fun fromJson(reader: JsonReader): `[`ApiErrorResponse`](../-api-error-response/index.md) |
| [toJson](to-json.md) | `fun toJson(writer: JsonWriter, value: `[`ApiErrorResponse`](../-api-error-response/index.md)`?): `[`Unit`](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-unit/index.html) |
