[app](../../index.md) / [com.jnj.vaccinetracker.common.data.models.api.response](../index.md) / [ApiErrorResponse](./index.md)

# ApiErrorResponse

`@JsonClass(true) data class ApiErrorResponse`
...
| Name | Summary |
|---|---|
| [&lt;init&gt;](-init-.md) | `ApiErrorResponse(message: `[`String`](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)`, status: `[`String`](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)`, details: `[`String`](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)`)` |
...
| Name | Summary |
|---|---|
| [STATUS_INVALID_SESSION](-s-t-a-t-u-s_-i-n-v-a-l-i-d_-s-e-s-s-i-o-n.md) | `const val STATUS_INVALID_SESSION: `[`String`](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html) |
