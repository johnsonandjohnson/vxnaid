[app](../../index.md) / [com.jnj.vaccinetracker.common.data.models.api.response](../index.md) / [UserJsonAdapter](./index.md)

# UserJsonAdapter

`class UserJsonAdapter : JsonAdapter<`[`User`](../-user/index.md)`>`

### Constructors

| Name | Summary |
|---|---|
| [&lt;init&gt;](-init-.md) | `UserJsonAdapter(moshi: Moshi)` |

### Functions

| Name | Summary |
|---|---|
| [fromJson](from-json.md) | `fun fromJson(reader: JsonReader): `[`User`](../-user/index.md) |
| [toJson](to-json.md) | `fun toJson(writer: JsonWriter, value: `[`User`](../-user/index.md)`?): `[`Unit`](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-unit/index.html) |
