[app](../../index.md) / [com.jnj.vaccinetracker.common.data.models.api.response](../index.md) / [SiteResponseJsonAdapter](./index.md)

# SiteResponseJsonAdapter

`class SiteResponseJsonAdapter : JsonAdapter<`[`SiteResponse`](../-site-response/index.md)`>`

### Constructors

| Name | Summary |
|---|---|
| [&lt;init&gt;](-init-.md) | `SiteResponseJsonAdapter(moshi: Moshi)` |

### Functions

| Name | Summary |
|---|---|
| [fromJson](from-json.md) | `fun fromJson(reader: JsonReader): `[`SiteResponse`](../-site-response/index.md) |
| [toJson](to-json.md) | `fun toJson(writer: JsonWriter, value: `[`SiteResponse`](../-site-response/index.md)`?): `[`Unit`](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-unit/index.html) |
