[app](../../index.md) / [com.jnj.vaccinetracker.common.data.models.api.response](../index.md) / [SiteJsonAdapter](./index.md)

# SiteJsonAdapter

`class SiteJsonAdapter : JsonAdapter<`[`Site`](../-site/index.md)`>`

### Constructors

| Name | Summary |
|---|---|
| [&lt;init&gt;](-init-.md) | `SiteJsonAdapter(moshi: Moshi)` |

### Functions

| Name | Summary |
|---|---|
| [fromJson](from-json.md) | `fun fromJson(reader: JsonReader): `[`Site`](../-site/index.md) |
| [toJson](to-json.md) | `fun toJson(writer: JsonWriter, value: `[`Site`](../-site/index.md)`?): `[`Unit`](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-unit/index.html) |
