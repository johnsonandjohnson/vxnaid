[app](../../index.md) / [com.jnj.vaccinetracker.common.data.models.api.response](../index.md) / [NamedValueJsonAdapter](./index.md)

# NamedValueJsonAdapter

`class NamedValueJsonAdapter : JsonAdapter<`[`NamedValue`](../-named-value/index.md)`>`

### Constructors

| Name | Summary |
|---|---|
| [&lt;init&gt;](-init-.md) | `NamedValueJsonAdapter(moshi: Moshi)` |

### Functions

| Name | Summary |
|---|---|
| [fromJson](from-json.md) | `fun fromJson(reader: JsonReader): `[`NamedValue`](../-named-value/index.md) |
| [toJson](to-json.md) | `fun toJson(writer: JsonWriter, value: `[`NamedValue`](../-named-value/index.md)`?): `[`Unit`](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-unit/index.html) |
