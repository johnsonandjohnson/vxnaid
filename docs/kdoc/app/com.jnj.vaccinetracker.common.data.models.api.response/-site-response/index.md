[app](../../index.md) / [com.jnj.vaccinetracker.common.data.models.api.response](../index.md) / [SiteResponse](./index.md)

# SiteResponse

`@JsonClass(true) data class SiteResponse`

### Constructors

| Name | Summary |
|---|---|
| [&lt;init&gt;](-init-.md) | `SiteResponse(results: `[`List`](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin.collections/-list/index.html)`<`[`Site`](../-site/index.md)`>)` |

### Properties

| Name | Summary |
|---|---|
| [results](results.md) | `val results: `[`List`](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin.collections/-list/index.html)`<`[`Site`](../-site/index.md)`>` |
