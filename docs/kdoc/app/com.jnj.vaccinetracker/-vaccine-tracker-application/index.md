[app](../../index.md) / [com.jnj.vaccinetracker](../index.md) / [VaccineTrackerApplication](./index.md)
...
| Name | Summary |
|---|---|
| [&lt;init&gt;](-init-.md) | `VaccineTrackerApplication()` |

### Functions

| Name | Summary |
|---|---|
| [applicationInjector](application-injector.md) | `fun applicationInjector(): AndroidInjector<out DaggerApplication>` |
