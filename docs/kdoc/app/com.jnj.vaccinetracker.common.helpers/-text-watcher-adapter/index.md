[app](../../index.md) / [com.jnj.vaccinetracker.common.helpers](../index.md) / [TextWatcherAdapter](./index.md)
...
| Name | Summary |
|---|---|
| [&lt;init&gt;](-init-.md) | `TextWatcherAdapter()` |

### Functions

| Name | Summary |
|---|---|
| [afterTextChanged](after-text-changed.md) | `open fun afterTextChanged(s: Editable?): `[`Unit`](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-unit/index.html) |
